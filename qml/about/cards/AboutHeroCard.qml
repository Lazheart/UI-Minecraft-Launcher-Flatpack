...
Rectangle {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            Text {
                text: qsTr("Version: ") + minecraftManager.getLauncherVersion()
            ...
            Text {
                Layout.fillWidth: true
                text: qsTr("Minecraft Bedrock Edition launcher for Linux with profile management, customization, and real-time logging.")
